...
def plot_redshift_comparison(truth_data, cluster_data, ind_bij, outpath):
    ...
    plt.savefig(outpath+"redshift_comparison.png", bbox_inches='tight')
    return 

#____________________________________________________
#position of associated clusters

def plot_cluster_and_halo_position(truth_data, cluster_data, ind_1w, ind_2w, ind_bij, outpath):
    ...
    plt.savefig(outpath+"cluster_and_halo_position.png", bbox_inches='tight')
    return fig, ax1, ax2
...
def plot_richness_mass(halo_data, cluster_data, ind_bij, zmin = 0, zmax = np.inf, min_richness=None, min_halo_mass=None, fig=None, ax=None, fmt='k.'):
    ...
    #plt.savefig(outpath+"richness_mass.png", bbox_inches='tight')
    return fig, ax
